...
--
-- Host: localhost
-- Generation Time: May 13, 2012 at 10:00 PM
...
--
-- Table structure for table `flyer_background_type`
--

CREATE TABLE `flyer_background_type` (
  `flyer_background_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `flyer_background_type_name` varchar(50) NOT NULL,
  `flyer_background_type_location` char(255) NOT NULL,
  PRIMARY KEY (`flyer_background_type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `flyer_background_type`
--

INSERT INTO `flyer_background_type` VALUES(1, 'Plain White', 'images/paper.jpg');
...
CREATE TABLE `image_flyers` (
  ...
  `image_flyer_flyer_background_type_id` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `image_flyers` VALUES(1, 'Minify Image Only', 3, 1, 1, '2012-01-24 01:41:13');
INSERT INTO `image_flyers` VALUES(2, 'Cake Image Flyer', 4, 1, 1, '2012-05-05 11:47:57');
...
CREATE TABLE `text_flyers` (
  ...
  `text_flyer_flyer_background_type_id` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `text_flyers` VALUES(1, 'test', 'test', 'test', '', 0, '', '', 'off', '', 1, 1, '2012-01-17 13:48:44');
INSERT INTO `text_flyers` VALUES(2, 'test', 'test', 'test', '', 0, '', '', 'off', '', 1, 1, '2012-01-17 14:52:05');
INSERT INTO `text_flyers` VALUES(3, 'test', 'test', 'test', '', 0, '', '', 'off', '', 1, 1, '2012-01-17 15:01:54');
INSERT INTO `text_flyers` VALUES(4, 'New Text Flyer', 'New Text Flyer', 'My Home', '01/31/2012', 1, 'Christopher Bartholomew', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_4_1.png', 1, 1, '2012-01-17 15:04:34');
INSERT INTO `text_flyers` VALUES(5, 'NowCorkIt.com - The digital corkboard', 'Text flyer', 'this is ', '01/17/2012', 1, 'Christopher Bartholomew', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_5_1.png', 1, 1, '2012-01-17 15:07:33');
INSERT INTO `text_flyers` VALUES(6, 'Flyer Development', 'This is a flyer in development', 'My Home', '01/31/2012', 1, 'Christopher', 'cbartholomew@gmail.com', 'off', '', 1, 1, '2012-01-19 23:56:27');
INSERT INTO `text_flyers` VALUES(7, 'testing edits', 'test', 'test', '01/31/2012', 1, 'test', 'test@test.com', 'on', 'flyers/qrcodes/qr_7_1.png', 1, 1, '2012-01-19 23:57:19');
INSERT INTO `text_flyers` VALUES(8, 'Flyer Test', 'Flyer Test', 'This Location', '01/31/2012', 1, 'Christopher', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_8_1.png', 1, 1, '2012-01-20 16:09:55');
INSERT INTO `text_flyers` VALUES(9, 'test', 'test', 'test', '', 0, '', '', 'off', '', 1, 1, '2012-01-20 16:11:22');
INSERT INTO `text_flyers` VALUES(10, 'test', 'test', 'test', '', 0, '', '', 'off', '', 1, 1, '2012-01-20 16:12:38');
INSERT INTO `text_flyers` VALUES(11, 'test', 'test', 'test', '', 0, '', '', 'off', '', 1, 1, '2012-01-20 16:13:04');
INSERT INTO `text_flyers` VALUES(12, 'MINIFY', 'MINIFY TEST', 'Home', '01/24/2012', 1, 'Christopher Bartholomew', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_12_1.png', 1, 1, '2012-01-24 01:24:59');
INSERT INTO `text_flyers` VALUES(13, 'This Should Post', 'This flyer should be the first flyer that shows on the corkboard', 'My house', '01/28/2012', 1, 'Christopher Bartholomew', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_13_1.png', 1, 1, '2012-01-28 16:39:36');
INSERT INTO `text_flyers` VALUES(14, 'Testing Flyer', 'Does this flyer break? I\\''m just checkign.', 'Some Location', '05/05/2012', 1, 'TEsting', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_14_1.png', 1, 1, '2012-05-05 14:04:48');
INSERT INTO `text_flyers` VALUES(15, 'Test 1', 'Test 1', 'test', '05/05/2012', 0, '', '', 'off', '', 1, 1, '2012-05-05 15:42:42');
INSERT INTO `text_flyers` VALUES(16, 'Test', 'test', 'test', '05/05/2012', 0, '', '', 'off', '', 1, 1, '2012-05-05 15:42:52');
INSERT INTO `text_flyers` VALUES(17, 'hello test', 'hellotest', 'hello test', '', 0, '', '', 'off', '', 1, 1, '2012-05-13 17:17:33');
...
CREATE TABLE `text_image_flyers` (
  ...
  `text_image_flyer_flyer_background_type_id` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `text_image_flyers` VALUES(1, 'Heart', 'Heart', 'Heart', '01/18/2012', 1, 'Chri', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_1_1.png', 1, 1, 1, '2012-01-17 15:03:45');
INSERT INTO `text_image_flyers` VALUES(2, 'Minfy w/ Image', 'Testing Minify w/ Images', 'Home', '01/24/2012', 1, 'Christopher Bartholomew', 'cbartholomew@gmail.com', 'on', 'flyers/qrcodes/qr_2_1.png', 1, 1, 2, '2012-01-24 01:40:25');
...
INSERT INTO `users` VALUES(1, '105499867526169935261', 2, 'cbartholomew@gmail.com', NULL, 'Christopher', 'Bartholomew', 21, 0, '2012-05-13 20:48:53', 0, '2012-01-17 10:09:15', 25);
