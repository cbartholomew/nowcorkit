...
$html .=  "<h3 class='ui-widget-header ui-corner-tr ui-corner-tl' style='padding:5px'>Step 1 - View Boards' Locations by State</h3>";
...
$html .=  "</table>";
$html .=  "</div>";
$html .=  "<h3 class='ui-widget-header ui-corner-tr ui-corner-tl' style='padding:5px'>Step 2 - Choose a Location to Post a Flyer</h3>";
...
$html .=  "</table>";
$html .=  "</div>";
$html .=  "<div id='map_canvas' class='ui-corner-all'></div>";
