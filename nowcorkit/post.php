...
echo "<form id='add_post' action='add_post.php' method='POST'>";
	...
	echo "<tbody>";
		echo "<tr>";
			...
			echo "<th class='ui-widget-header table_data'><label>City</label></th>";
			echo "<th class='ui-widget-header table_data'><label>State</label></th>";
			echo "<th class='ui-widget-header table_data'><label>Zip</label></th>";
